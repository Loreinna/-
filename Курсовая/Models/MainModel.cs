...
namespace Курсовая.Models
{
    ...
    public class ProductRepository
    {
        ...
        public void LoadProducts()
        {
            ...
            Products.Add(new Product("Мороженое", 70, false, "Images\\мороженое.jpg"));
            Products.Add(new Product("Вода минеральная 0.5л", 30, false, "Images\\вода.jpg"));
            Products.Add(new Product("Чай черный", 70, false, "Images\\чай.jpg"));
            ...
            Products.Add(new Product("Вино красное", 300, false, "Images\\вино.jpg"));
            Products.Add(new Product("Пиво светлое", 50, false, "Images\\пиво.jpg"));
            ...
            Products.Add(new Product("Салями", 180, false, "Images\\салями.jpg"));
